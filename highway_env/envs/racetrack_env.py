...
class RacetrackEnv(CausalInterventionMixin, AbstractEnv):
    """
    ...
    #  lane_centering_cost      MID-EPISODE    lane centering penalty scale
    #  lane_centering_reward    MID-EPISODE    reward weight for centering
    #  action_reward            MID-EPISODE    reward penalty for large actions
    #  duration                 MID-EPISODE    episode time limit
    #  other_vehicles           EPISODE-LEVEL  number of traffic vehicles
    #  controlled_vehicles      EPISODE-LEVEL  number of ego vehicles
    #  terminate_off_road       EPISODE-LEVEL  termination mode
        ...
        config.update(
            {
                ...
                "driver_aggressiveness": None,  # float in [0,1] or None
            }
        )
        return config
