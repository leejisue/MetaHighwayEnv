...
class MergeEnv(CausalInterventionMixin, AbstractEnv):
    """
    ...
    #  merging_speed_reward     MID-EPISODE    altruistic penalty weight
    ...
    def _is_terminated(self) -> bool:
        """The episode is over when a collision occurs, when the access ramp has been passed, or when off-road."""
        return (
