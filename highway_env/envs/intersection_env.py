...
class IntersectionEnv(CausalInterventionMixin, AbstractEnv):
    """
    A 4-way intersection environment.
    ...
    #  ───────────────────────  ─────────────  ────────────────────────────
    #  driver_aggressiveness    MID-EPISODE    IDM/MOBIL params on traffic
    #  speed_limit              MID-EPISODE    lane.speed_limit for all lanes
    #  collision_reward         MID-EPISODE    reward weight in config
    #  high_speed_reward        MID-EPISODE    reward weight in config
    #  arrived_reward           MID-EPISODE    reward for reaching destination
    #  reward_speed_range       MID-EPISODE    [low, high] speed mapping
    #  duration                 MID-EPISODE    episode time limit
    #  spawn_probability        MID-EPISODE    new vehicle spawn rate
    #  initial_vehicle_count    EPISODE-LEVEL  number of vehicles at reset
    #  destination              EPISODE-LEVEL  ego destination (requires reset)
    ...
    def _apply_mid_episode_intervention(
        ...
        """Intersection-specific mid-episode intervention handlers."""
        # Delegate common handlers to the mixin
        super()._apply_mid_episode_intervention(variable, value)
        # spawn_probability, arrived_reward, etc. are purely config-driven.
